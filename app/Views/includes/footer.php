                                    ...
                                    <li class="d-flex gap-3 align-items-center py-2 footer-info-widget-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="12"
                                            ...
                                            <path
                                                ...
                                                fill="currentColor" /></svg>infoyourortencey@gmail.com
                                    </li>
                                    <li class="d-flex gap-3 align-items-center py-2 footer-info-widget-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="23"
                                            ...
                                            <path
                                                ...
                                                fill="currentColor" /></svg>374 A Tower, William Road Blvd <br />,
                                        Melbourne 2721,
                                        IL, USA
                                    </li>
                                </ul>
    ...
    <!-- Category Modal -->
    <div class="modal fade categor" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
