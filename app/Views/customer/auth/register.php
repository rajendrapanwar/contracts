                  ...
                  <div class="form-container">
                    <div class="row gy-3">
                      <div class="form-input col-lg-6">
                        ...
                        <input type="text" id="fname" placeholder="First Name" class="form-control shadow-none">
                      </div>
                      <div class="form-input col-lg-6">
                        <label for="lname" class="form-label">Last Name <span class="text-lime-300">*</span></label>
                        <input type="text" id="lname" placeholder="Last Name" class="form-control shadow-none">
                      </div>
                      <div class="form-input col-lg-6">
                        <label for="phone" class="form-label">Phone <span class="text-lime-300">*</span></label>
                        <input type="text" id="phone" placeholder="01403817190" class="form-control shadow-none">
                      </div>
                      <div class="form-input col-lg-6">
                        <label for="phone" class="form-label">Email <span class="text-lime-300">*</span></label>
                        <input type="text" id="email" placeholder="demo@email.com" class="form-control shadow-none">
                      </div>
                      <div class="form-input col-lg-6">
