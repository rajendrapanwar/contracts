                        ...
                        <div class="d-flex gap-3">
                          ...
                          <span class="job-location">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="11" viewBox="0 0 10 11" fill="none">
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M5.15385 11C6.89904 11 9.80769 7.58895 9.80769 4.88889C9.80769 2.18883 7.72409 0 5.15385 0C2.5836 0 0.5 2.18883 0.5 4.88889C0.5 7.58895 3.40865 11 5.15385 11ZM5.15371 6.59992C6.01046 6.59992 6.70499 5.86119 6.70499 4.94992C6.70499 4.03865 6.01046 3.29992 5.15371 3.29992C4.29696 3.29992 3.60243 4.03865 3.60243 4.94992C3.60243 5.86119 4.29696 6.59992 5.15371 6.59992Z" fill="#13544E"></path></svg>Dhaka</span>
                        </div>
                      </div>
                    </div>
                    <div class="col-auto">
                    ...
                    <li class="py-3 d-flex justify-content-between gap-3 text-dark-200 company-card-list align-items-center">
                      <div class="d-flex gap-3 align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 20" fill="none">
                          <path d="M20.7083 19H3.29167C2.0285 19 1 17.878 1 16.5V3.5C1 2.122 2.0285 1 3.29167 1H20.7083C21.9715 1 23 2.122 23 3.5V16.5C23 17.878 21.9715 19 20.7083 19ZM3.29167 2C2.53358 2 1.91667 2.673 1.91667 3.5V16.5C1.91667 17.327 2.53358 18 3.29167 18H20.7083C21.4664 18 22.0833 17.327 22.0833 16.5V3.5C22.0833 2.673 21.4664 2 20.7083 2H3.29167Z" fill="#22BE0D" stroke="#22BE0D" stroke-width="0.4"></path>
                          <path d="M7.86589 10C6.60272 10 5.57422 8.878 5.57422 7.5C5.57422 6.122 6.60272 5 7.86589 5C9.12905 5 10.1576 6.122 10.1576 7.5C10.1576 8.878 9.12905 10 7.86589 10ZM7.86589 6C7.1078 6 6.49089 6.673 6.49089 7.5C6.49089 8.327 7.1078 9 7.86589 9C8.62397 9 9.24089 8.327 9.24089 7.5C9.24089 6.673 8.62397 6 7.86589 6Z" fill="#22BE0D" stroke="#22BE0D" stroke-width="0.4"></path>
                          <path d="M11.5378 15C11.2848 15 11.0794 14.776 11.0794 14.5V13.5C11.0794 12.673 10.4625 12 9.70443 12H6.03776C5.27968 12 4.66276 12.673 4.66276 13.5V14.5C4.66276 14.776 4.45743 15 4.20443 15C3.95143 15 3.74609 14.776 3.74609 14.5V13.5C3.74609 12.122 4.77459 11 6.03776 11H9.70443C10.9676 11 11.9961 12.122 11.9961 13.5V14.5C11.9961 14.776 11.7908 15 11.5378 15Z" fill="#22BE0D" stroke="#22BE0D" stroke-width="0.4"></path>
                          <path d="M19.7904 7H14.2904C14.0374 7 13.832 6.776 13.832 6.5C13.832 6.224 14.0374 6 14.2904 6H19.7904C20.0434 6 20.2487 6.224 20.2487 6.5C20.2487 6.776 20.0434 7 19.7904 7Z" fill="#22BE0D" stroke="#22BE0D" stroke-width="0.4"></path>
                          <path d="M19.7904 11H14.2904C14.0374 11 13.832 10.776 13.832 10.5C13.832 10.224 14.0374 10 14.2904 10H19.7904C20.0434 10 20.2487 10.224 20.2487 10.5C20.2487 10.776 20.0434 11 19.7904 11Z" fill="#22BE0D" stroke="#22BE0D" stroke-width="0.4"></path>
                          <path d="M19.7904 15H14.2904C14.0374 15 13.832 14.776 13.832 14.5C13.832 14.224 14.0374 14 14.2904 14H19.7904C20.0434 14 20.2487 14.224 20.2487 14.5C20.2487 14.776 20.0434 15 19.7904 15Z" fill="#22BE0D" stroke="#22BE0D" stroke-width="0.4"></path>
                        </svg>
                        Member Since
                      </div>
                    ...
                    <li class="py-3 d-flex justify-content-between gap-3 text-dark-200 company-card-list align-items-center">
                      <div class="align-items-center d-flex gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          <path d="M12.25 3.25C12.25 2.00736 13.2574 1 14.5 1H16.75C17.9926 1 19 2.00736 19 3.25V5.5C19 6.74264 17.9926 7.75 16.75 7.75H14.5C13.2574 7.75 12.25 6.74264 12.25 5.5V3.25Z" stroke="#22BE0D" stroke-width="1.4"></path>
                          <path d="M1 14.5C1 13.2574 2.00736 12.25 3.25 12.25H5.5C6.74264 12.25 7.75 13.2574 7.75 14.5V16.75C7.75 17.9926 6.74264 19 5.5 19H3.25C2.00736 19 1 17.9926 1 16.75V14.5Z" stroke="#22BE0D" stroke-width="1.4"></path>
                          <path d="M1 3.25C1 2.00736 2.00736 1 3.25 1H5.5C6.74264 1 7.75 2.00736 7.75 3.25V5.5C7.75 6.74264 6.74264 7.75 5.5 7.75H3.25C2.00736 7.75 1 6.74264 1 5.5V3.25Z" stroke="#22BE0D" stroke-width="1.4"></path>
                          <path d="M12.25 14.5C12.25 13.2574 13.2574 12.25 14.5 12.25H16.75C17.9926 12.25 19 13.2574 19 14.5V16.75C19 17.9926 17.9926 19 16.75 19H14.5C13.2574 19 12.25 17.9926 12.25 16.75V14.5Z" stroke="#22BE0D" stroke-width="1.4"></path>
                        </svg>
                        Categories
                      </div>
                      <div>
                    ...
                    <li class="py-3 d-flex justify-content-between gap-3 text-dark-200 company-card-list align-items-center">
                      <div class="d-flex gap-3 text-dark-200 align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
                          <mask id="mask0_426_8309" style="mask-type: luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="21" height="21">
                            <path d="M20.0167 20.0167V0.65H0.65V20.0167H20.0167Z" fill="white" stroke="white" stroke-width="1.3"></path>
                          </mask>
                          <g mask="url(#mask0_426_8309)">
                            <path d="M12.1536 5.08931H18.3243C19.3943 5.08931 20.2618 5.95675 20.2618 7.02682V17.5183C20.2618 18.5883 19.3943 19.4558 18.3243 19.4558H2.33985C1.26978 19.4558 0.402344 18.5883 0.402344 17.5183V7.02682C0.402344 5.95675 1.26978 5.08931 2.33985 5.08931H8.52078" stroke="#22BE0D" stroke-width="1.3" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M20.2618 8.31406C20.2618 10.448 18.5319 12.1779 16.398 12.1779H4.26614C2.13221 12.1779 0.402344 10.448 0.402344 8.31406" stroke="#22BE0D" stroke-width="1.3" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M10.3425 14.6929C9.49532 14.6929 8.80859 14.0061 8.80859 13.159V10.9162C8.80859 10.6315 9.03936 10.4008 9.32405 10.4008H11.3609C11.6455 10.4008 11.8763 10.6315 11.8763 10.9162V13.159C11.8763 14.0061 11.1896 14.6929 10.3425 14.6929Z" stroke="#22BE0D" stroke-width="1.3" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M5.32812 5.08936V3.1485C5.32812 2.07843 6.19556 1.21099 7.26563 1.21099H13.4011C14.4711 1.21099 15.3386 2.07843 15.3386 3.1485V5.08936" stroke="#22BE0D" stroke-width="1.3" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M5.32812 3.14856H15.3386" stroke="#22BE0D" stroke-width="1.3" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                          </g>
                        </svg>
                        Total Job
                      </div>
              ...
              <div class="proposal-container">
                ...
                <form>
                  <div class="d-flex flex-column gap-4">
                    ...
                    <div class="proposal-input-container">
                      <label for="time" class="proposal-form-label">Write Cover Letter*</label>
                      <textarea placeholder="Write Cover Letter minimum 150 characters..." class="form-textarea shadow-none"></textarea>
                    </div>
                    <div class="proposal-input-container">
                      <div class="file-input">
                        <input type="file" name="file-input" id="file-input" class="file-input__input">
                        <label class="file-input__label" for="file-input">
                          <span class="text-dark-200 text-18">Drag &amp; Drop or
                            <b class="text-lime-300 fw-semibold">Choose File</b>
                            to upload</span></label>
                      </div>
                    </div>
