 ...
 <main>
          ...
          <div class="row">
            <div class="col-auto">
              <div class="position-relative z-2 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="linear">
                <h2 class="section-title-light mb-2">About</h2>
          ...
          <div class="row justify-content-center">
            <div class="col-auto">
              <div class="text-center mb-40">
                <p class="section-subtitle fw-semibold">Best Feature</p>
                <h2 class="section-title fw-bold">Our Latest Features</h2>
              </div>
            </div>
          </div>
          <div class="row justify-content-center g-4">
            <div class="col-xl col-lg-4 col-md-6">
              <div class="feature-card">
                <img src="assets/img/features/1.svg" class="mx-auto d-block" alt="">
            ...
            <div class="col-xl col-lg-4 col-md-6">
              <div class="feature-card">
                <img src="assets/img/features/2.svg" class="mx-auto d-block" alt="">
                <h3 class="fw-bold feature-card-title text-center">
            ...
            <div class="col-xl col-lg-4 col-md-6">
              <div class="feature-card">
                <img src="assets/img/features/3.svg" class="mx-auto d-block" alt="">
                <h3 class="fw-bold feature-card-title text-center">
                  Paid Membership
                </h3>
              </div>
            ...
            <div class="col-xl col-lg-4 col-md-6">
              <div class="feature-card">
                <img src="assets/img/features/4.svg" class="mx-auto d-block" alt="">
                <h3 class="fw-bold feature-card-title text-center">
                  Custom Order
                </h3>
              </div>
            ...
            <div class="col-xl col-lg-4 col-md-6">
              <div class="feature-card">
                <img src="assets/img/features/5.svg" class="mx-auto d-block" alt="">
                <h3 class="fw-bold feature-card-title text-center">
                  Live Chat System
                </h3>
              </div>
      ...
      <section class="about-company position-relative pt-110 pb-150 bg-offWhite">
        <div class="container">
          <div class="row g-5">
            <div class="col-lg-6">
              <div class="text-left">
                <p class="section-subtitle fw-semibold mb-2">About Company</p>
                ...
                <div class="d-flex flex-column flex-md-row gap-4 align-items-md-center mt-40">
                  <div>
                    <a href="#" class="w-btn-secondary-xl">
                      Read More
                  ...
                  <div class="d-flex gap-3 align-items-center">
                    <img src="assets/img/avatar/u-sm-1.png" class="rounded-circle ceo-avatar" alt="">
            ...
            <div class="col-lg-6">
              <ul class="position-relative about-img-group">
                <li class="position-lg-absolute d-flex flex-column flex-md-row gap-3">
                  <img src="assets/img/about/img-1.png" class="" alt="">
                  <img src="assets/img/about/img-2.png" class="d-md-block d-lg-none d-xl-block z-2" alt="">
                </li>
                <li class="position-absolute d-none d-lg-block">
                  <img src="assets/img/about/img-3.png" class="" alt="">
                </li>
              </ul>
            </div>
          </div>
      ...
      <section class="py-110">
        <div class="container">
          <div class="row g-5">
            <div class="col-xl-5">
              <div class="feature-tab-left aos-init" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="linear">
                <div class="mb-5">
            ...
            <div class="col-xl-7">
              <div class="feature-tab-right aos-init" data-aos="fade-up" data-aos-duration="800" data-aos-easing="linear">
                <div class="position-relative feature-tab-images">
                  <img src="assets/img/about/f-girl.png" class="img-fluid" alt="">
                  <img src="assets/img/about/v-card-1.png" class="position-absolute feature-tab-img-one d-none d-xl-block" alt="">
                  <img src="assets/img/about/v-card-2.png" class="position-absolute feature-tab-img-two d-none d-xl-block" alt="">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-darkGreen cta-area-bg">
            <div class="row align-items-center">
              <div class="col-12 col-xl-7">
                <div class="cta-content aos-init" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="linear">
                  ...
                  <a href="job-posts.html" class="cta-btn-link">
                    Job Post Now
      ...
      <section class="bg-offWhite py-110">
        ...
        <div class="swiper testimonialsSlider swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
          <div class="swiper-wrapper" id="swiper-wrapper-4fef69a76dc13e45" aria-live="off" style="transition-duration: 10000ms; transform: translate3d(-1008.12px, 0px, 0px);"><div class="swiper-slide" role="group" aria-label="8 / 10" data-swiper-slide-index="7" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                ...
                <div class="testimonial-meta d-flex align-items-center justify-content-between">
                  <div class="d-flex gap-3 align-items-center">
                    <div>
                      <img src="assets/img/testimonial/au-1.png" class="testimonial-author-img" alt="">
                    </div>
                    <div>
            ...
            </div><div class="swiper-slide" role="group" aria-label="9 / 10" data-swiper-slide-index="8" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            </div><div class="swiper-slide" role="group" aria-label="10 / 10" data-swiper-slide-index="9" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            <div class="swiper-slide swiper-slide-prev" role="group" aria-label="1 / 10" data-swiper-slide-index="0" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            <div class="swiper-slide swiper-slide-active" role="group" aria-label="2 / 10" data-swiper-slide-index="1" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            <div class="swiper-slide swiper-slide-next" role="group" aria-label="3 / 10" data-swiper-slide-index="2" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            <div class="swiper-slide" role="group" aria-label="4 / 10" data-swiper-slide-index="3" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            <div class="swiper-slide" role="group" aria-label="5 / 10" data-swiper-slide-index="4" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            <div class="swiper-slide" role="group" aria-label="6 / 10" data-swiper-slide-index="5" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            <div class="swiper-slide" role="group" aria-label="7 / 10" data-swiper-slide-index="6" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
        ...
        <div class="swiper testimonialsSliderBottom mt-4 swiper-initialized swiper-horizontal swiper-free-mode swiper-backface-hidden">
          <div class="swiper-wrapper" id="swiper-wrapper-51487cc108bb67e56" aria-live="off" style="transition-duration: 8000ms; transform: translate3d(-201.625px, 0px, 0px);"><div class="swiper-slide" role="group" aria-label="8 / 10" data-swiper-slide-index="7" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            </div><div class="swiper-slide swiper-slide-prev" role="group" aria-label="9 / 10" data-swiper-slide-index="8" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            </div><div class="swiper-slide swiper-slide-active" role="group" aria-label="10 / 10" data-swiper-slide-index="9" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            <div class="swiper-slide swiper-slide-next" role="group" aria-label="1 / 10" data-swiper-slide-index="0" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            <div class="swiper-slide" role="group" aria-label="2 / 10" data-swiper-slide-index="1" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
            ...
            <div class="swiper-slide" role="group" aria-label="3 / 10" data-swiper-slide-index="2" style="width: 373.25px; margin-right: 30px;">
              <div class="testimonial-card bg-white">
                <div class="testimonial-content">
                  <div class="d-flex gap-2 align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
      ...
      <section class="pb-80 bg-offWhite">
        <div class="container">
          <div class="row justify-content-center mb-40">
            <div class="col-auto">
              <div class="text-center">
                <h2 class="section-title fw-bold mb-3">Our Faq</h2>
                <p class="section-desc">Explore Our Informative FAQ Section</p>
              </div>
            </div>
          </div>
          <div class="row justify-content-center">
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                        How do I create a freelance profile on the marketplace?
                      </button>
                    </h2>
                    <div id="flush-collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample">
                      <div class="accordion-body">
                        <p>
                          Vestibulum quis neque nunc. Maecenas pharetra libero
                          id efficitur gravida. Aenean risus enim, condimentum
                          vela aliquams in, consequat nec lacus. Aenean faucibus
                          venenatis aliquet. Sed nulla quam, vehicula ut libero
                          molestie volu our as satpat quam. Phasellus semper
                          vitae tellus sit amet scelerisque
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
                        What steps are involved in submitting a proposal for a
                        job?
                      </button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
                        Are there any fees associated with using the freelance
                        marketplace?
                      </button>
                    </h2>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFour" aria-expanded="false" aria-controls="flush-collapseFour">
                        What should I do if I encounter issues with a client or
                        project?
                      </button>
                    </h2>
