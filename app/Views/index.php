                        ...
                        <article class="swiper-slide">
                            <div class="service-card bg-white">
                                ...
                                <div class="service-card-content">
                                    ...
                                    <div class="d-flex align-items-center service-card-author">
                                        <img src="assets/img/avatar/u-sm-2.png" class="service-card-author-img"
                                            alt="" />
                                        <a href="#" class="service-card-author-name">Nankathan</a>
                                    </div>
                                </div>
                        ...
                        <article class="swiper-slide">
                            <div class="service-card bg-white">
                                ...
                                <div class="service-card-content">
                                    ...
                                    <div class="d-flex align-items-center service-card-author">
                                        <img src="assets/img/avatar/u-sm-3.png" class="service-card-author-img"
                                            alt="" />
                        ...
                        <article class="swiper-slide">
                            <div class="service-card bg-white">
                                ...
                                <div class="service-card-content">
                                    ...
                                    <div class="d-flex align-items-center service-card-author">
                                        <img src="assets/img/avatar/u-sm-4.png" class="service-card-author-img"
                                            alt="" />
        ...
        <section class="top-sellers-area bg-offWhite py-110">
            <div class="container">
                ...
                <div class="row row-gap-4 justify-content-center row-cols-md-2 row-cols-lg-3 row-cols-xl-5">
                    ...
                    <article>
                        <div class="bg-white top-seller-card position-relative" data-aos="fade-up"
